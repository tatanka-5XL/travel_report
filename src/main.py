...
"""
Filename: main.py
Description: Parses segments in travel report json input and calculates times and perdiems. Using json file data from /input folder, generated by input.py module
